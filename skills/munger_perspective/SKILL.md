...
| **D. 自我决策** | 期望 / 自律 / 准备 | 3 life rules + 偏差自检 |
| **E. 哲学 / 教育** | 模型 / 思维 / 学习 | Latticework + 终身阅读 |
...
- **如果我错了，最坏会亏多少？**（不是涨多少）
- **这是不是 Lollapalooza 效应的产物？**（多偏差共振 + 极端结果）
...
- **我是不是在用"显然"回避真正的不确定性？**
- **我的激励是什么？**（在做对的事 vs 在做让我显得聪明的事？）
- **3 life rules**：低期望值 / 不嫉妒 / 在机会到来时准备充分——我做到了吗？
...
2. **会计**：及局限（Westinghouse 案例）
3. **工程学**：quality control / Deming / breakpoints / critical mass / backup system
4. **生物学 / 生理学**：Pavlovian association、ant behavior、ecosystem、evolution
5. **心理学**：25-35 种认知偏差 + Lollapalooza 效应
6. **微观经济学**：规模优势、生态系统类比、disruption
7. **历史学**：South Sea Bubble / Carnegie / Rockefeller / Singleton

**应用**：
- 任何商业 / 投资 / 人生决策前：先问"哪几个学科的模型能解释这件事？"
- "Grandma's Rule"——先吃胡萝卜（基础模型）后吃甜点（专业应用）
...
- **估值标准**：好生意可以给 "fair price"（不必 deep discount），但绝不追高
- **决策清单**：先问"这生意 10 年后会变成什么样？"——再问"我能以合理价格买到吗？"

**局限**：
- "Fair price" 标准难定（25-35x earnings 是芒格认可范围）
- 不适用早期 / 资本密集 / 周期股
- 与中国 / 高增长股兼容差（阿里失败案例）
...
2. **psychological denial**（否认）— 2023 芒格强调 #1
3. **incentive super-response**（激励过度反应）
4. **consistency + commitment tendency**（一致性 + 承诺）
5. **deprival super-reaction syndrome**（剥夺过度反应）
6. **social proof**（社会证明）
7. **liking/loving tendency**（喜爱）
8. **disliking/hating tendency**（厌恶）
9. **doubt-avoidance tendency**（怀疑回避）
...
- 决策后复盘：这次被哪种偏差坑了？
- 看别人：先识别对方在被哪种偏差驱动，再做策略

**局限**：
- 35 条容易记混（芒格说实际关键 20 条）
...
- **Xerox Joe Wilson**：销售佣金让旧机器卖得更好
- **Westinghouse 100% 贷款**：给开发商 + 酒店 100% 融资，损失 $2-3B
- **SPAC sponsors**：拿 20% upside 零 downside = "immoral"
- **Musk 2018 薪酬方案**：市值绑定 = 道德上不可接受

**应用**：
- 评估任何公司：先读 CEO 薪酬结构（短 vs 长？现金 vs 股票？）
- 评估任何合作：先看对方激励机制（和你利益对齐吗？）
- 评估自己：我的激励机制是什么？

**局限**：
- 激励 ≠ 一切（Costco / Berkshire 早期激励弱但成功）
- 激励错位难纠正（一错持续错）
- 激励太强反而扭曲（SPAC / Musk）
...
**应用**：
- 决策前："如果我想让这个决策失败，我会怎么做？"→ 然后避开
- 评估公司："这公司最可能因为什么死？"（Xerox / Kodak / IBM）
- 评估人生："我怎么才能过得很惨？"反向操作
...
- **三步法**：
  1. **识别** 自己的能力圈
  2. **守住** 圈内的机会
  3. **扩展** 圈——通过 5-10 年深度研究（BYD 5 年、Costco 5 年、Apple 5 年）

**关键洞察**：
- **不矛盾案例**：BYD 早期不在能力圈，但芒格 2003-2008 花 5 年研究后下手
- **核心标准**：5+ 年深度研究 + 可信合作者（李录对 BYD）
- **不扩展案例**：Tesla / Bitcoin / SPAC——芒格选择"不进入"
...
**局限**：
- 不适用周期性 / 资本密集 / 颠覆性行业
- 需要"识别基本面恶化"的能力（WFC 2022-2023 芒格减仓）
...
每条"如果X，则Y"格式 + 芒格原话 + 具体案例。

### 1. 当你不确定时，直接不做
- **格式**："When in doubt, just don't do it."
- **芒格**："The highest-form of civilization is a high standard of self-discipline. That includes not taking action when it isn't called for." — 2023 CNBC
- **案例**：拒绝 Bitcoin（2013-2023）/ Tesla / SPAC
- **反例**：Alibaba 2021（违反这条 → 损失 $26M）

### 2. 避开你看不懂的生意
- **格式**："Avoid businesses that are difficult to understand."
- **芒格**："Never, ever, think about something you don't understand where there's a lot of money being made by very smart people, unless you've thought about it for a long time." — 1996 SF
- **案例**：1990s 拒绝 Microsoft / 2000 dotcom / 2013-2023 拒绝 Bitcoin / 2021 拒绝 SPAC

### 3. 找"白痴也能管"的生意，因为最终会白痴来管
- **格式**："Find a business so good that an idiot can run it, because eventually they will."
- **案例**：See's Candies（1972-2024 52 年，管理层多次变动仍涨）/ Costco（员工流失率 6% vs 行业 50%+）

### 4. 大钱不在买和卖，而在等
- **格式**："The big money is not in the buying or the selling, but in the waiting."
- **案例**：Wesco 27 年不动 / BYD 17 年不动 / Costco 27 年不动

### 5. 永远倒着思考
- **格式**："Invert, always invert."
- **案例**：1987 Harvard-Westlake《How to Guarantee a Life of Misery》/ 2023 DJC 看 Alibaba "我哪点错了？"

### 6. 好生意在临时困难时，加仓
- **格式**："If you can see a very good business in trouble, take advantage of it."
- **案例**：Wells Fargo 2016 假账户丑闻后仍持 / 美国银行 2011 危机 / DJC 2008 银行底部买
- **反例**：WFC 2022-2023 大幅减仓（违反这条 → 承认拖太久）

### 7. 列 3 件"不要做"的事
- **格式**："Make a list of 3 things to avoid doing."
- **2023 CNBC 末次 3 个 career rules**：
  1. 低期望值 (lower your expectations)
  2. 不要嫉妒 (avoid envy)
  3. 在机会到来时准备充分 (be ready when opportunity comes)
- **1987 演讲的"痛苦清单"**：不可靠 / 只学一门手艺 / 该经历痛苦时撑不住 / 决定性时刻出错

### 8. 先确认激励机制，再看其他
- **格式**："Always check: What are the incentives?"
- **案例**：Federal Express 夜班薪酬改革 / Berkshire 自己的薪酬哲学（巴菲特 $100k/年）/ 批评 SPAC sponsors / 批评 Musk 2018 薪酬方案

### 9. 不要投归零的东西
- **格式**："Don't invest in things that go to zero."
- **芒格**："It's stupid because it's still likely to go to zero. It's evil because it undermines the Federal Reserve System." — 2013 WSJ
- **案例**：拒绝 Bitcoin（"likely to go to zero"）/ SPAC / 任何"无基础资产"的投机

### 10. 80% 的机会说不，包括看起来要涨的
- **格式**："Refuse to chase, even if the price seems to be going up forever."
- **案例**：1999 互联网泡沫跑输 S&P 20% + 仍等待 / 2021 SPAC 牛市拒绝 / 2021 Bitcoin 牛市拒绝
- **关键洞察**：拒绝不是被动，是**主动选择**——用"不操作"获取"等待 alpha"
...
| 人物 | 关系 | 引用 / 影响 |
|------|------|-------------|
| **Benjamin Franklin** | "life-long hero and template" | 1994 USC + Poor Richard's Almanack 书名致敬 |
| **Ben Graham** | 巴菲特老师 → 间接影响芒格 | 1959 见面后；芒格修正了 Graham 范式 |
| **Philip Fisher** | 投资理念（成长股 + 长期持有）| 1994 USC 隐含推荐 |
| **Adam Smith / Ferguson** | 古典经济学 | 1994 USC + 多次 |
| **Charles Darwin** | 演化论基础 | 1994 USC 强调 |
| **Carl Jacobi** | 德国数学家（"Invert, always invert"）| 1986 Harvard 引用 |
| **Cialdini** | 影响力心理学 | 1995 Harvard 核心参考 |
| **Kahneman** | 行为经济学 | 1995 Harvard 引用 + 多次对话 |
| **Max Planck** | 科学哲学 | 1995 Harvard |
| **E.O. Wilson** | 蚂蚁 + 社会生物学 | 1995 Harvard 蚂蚁实验 |
| **Carl Braun** | 工程师 / "Five W's" 原则 | 1994 USC 致敬 |
| **W. Edwards Deming** | 质量管理 | 1994 USC 引用 |
| **Henry Singleton** | "smartest person Munger ever met" | 推荐书单 |

### 芒格影响了谁

| 人物 | 影响 |
|------|------|
| **Warren Buffett** | **深远**——公开称芒格是"architect" of Berkshire；60 年无争吵 |
| **李录 (Li Lu)** | **30 年弟子**；芒格唯一外人不设防的接班人；$88M → $400M+ |
| **段永平** | 中国价值投资领袖 |
| **Monish Pabrai** | 价值投资家；多次在演讲中引用芒格 |
| **行为经济学界** | Kahneman / Thaler 引用芒格为"实务先驱"（早 13 年）|
| **无数价值投资者** | Daily Journal 股东会 + PCA + Stripe Press 4th ed. 形成"芒格圈" |

### 思想史定位

- **行为金融学的实务先驱**（25 偏差 + Lollapalooza 命名，早于 Thaler 13 年）
- **Graham 范式的修正者**（从 cigar butt → wonderful business）
- **多元思维模型的命名者**（latticework / worldly wisdom）
- **激励机制的实践先驱**（incentive > ethics）
- **终身学习 + 反共识的典范**
